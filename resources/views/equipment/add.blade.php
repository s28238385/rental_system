    ...
    <div class="col-4">
        ...
        <form action="{{ route('equipment.add') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="genre" name="genre" class="form-control" placeholder="種類" autocomplete="off" required>
            </div>
            <div class="form-group">
                <label for="item">項目<span class="required">*</span></label>
                <input type="text" id="item" name="item" class="form-control" placeholder="項目" autocomplete="off" required>
            </div>
            <div class="form-group">
                <label for="quantity">數量<span class="required">*</span></label>
                <input type="text" id="quantity" name="quantity" class="form-control" placeholder="數量" autocomplete="off" required>
            </div>
