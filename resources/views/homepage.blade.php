            ...
            <div class="black-background px-3 pt-4 pb-2 text-center mh-85 overflow-auto scrollbar">
                    ...
                    <div>
                        ...
                        @if(Auth::check())
                            <div>
                                ...
                                <div id="subindex" class="d-none pb-3">
                                    <a class="text-decoration-none" href=""><h5 class="px-2 yellow-subindex">單次預約</h5></a>
                                    <a class="text-decoration-none" href=""><h5 class="px-2 yellow-subindex">長期預約</h5></a>
                                </div>
                            </div>
                            @can('manager')
                                <div>
                                    ...
                                    <div id="subindex" class="d-none pb-3">
                                        <a class="text-decoration-none" href="{{route('equipment.add')}}"><h5 class="px-2 yellow-subindex">新增設備</h5></a>
                                        <a class="text-decoration-none" href="#"><h5 class="px-2 yellow-subindex">設備清單</h5></a>
                                    </div>
                                </div>
                            @endcan
                        @endif
                ...
                @if(Auth::check())
                    <div class=" mt-4 d-flex inline-flex justify-content-center">
                        @can('manager')
                            <a class="text-decoration-none px-1" href="{{route('user.userlist')}}"><h6 class="text-muted">管理使用者</h6></a>
                        @endcan
                        <a class="text-decoration-none px-1" href="{{route('user.changepw')}}"><h6 class="text-muted">修改密碼</h6></a>
                        <a class="text-decoration-none px-1" href="{{route('user.logout')}}"><h6 class="text-muted">登出</h6></a>
                    </div>
                @else
                    <div class="mt-4">
