...
class SearchingClassroomTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $Classroom = new \App\SearchingClassroom([
            ...
            'equipmentDescription' => '座位數：17-28
        ...
        $Classroom = new \App\SearchingClassroom([
            ...
            'equipmentDescription' => '座位數：138-144
            基本設備：筆記型電腦(含網路)、投影機、麥克風、冷氣
            網路：無線網路
            聲音輸入：講桌3.5音源輸入
            顯示訊號輸入：VGA、HDMI
        ...
        $Classroom = new \App\SearchingClassroom([
            ...
            'equipmentDescription' => '※預約請至933門口月曆登記及查詢預約情形。
            座位數：15 
            基本設備：投影機、冷氣 
            網路：無線網路 　 
            聲音輸入：無
